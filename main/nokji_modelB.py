...
from models.recurrent_models_pyramid5 import LSTMGenerator, LSTMDiscriminator
...
os.environ["CUDA_VISIBLE_DEVICES"]="1" #온전히 1번 gpu에만 할당
...
for i in range(1,6):
    ...
    end_name = 'data/split/nokji_train.csv'  # ISSDA의 80%인 training data
    ...
    for epoch in range(opt_trn.epochs - 20):
