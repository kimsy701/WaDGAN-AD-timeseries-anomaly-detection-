...
from models.recurrent_models_pyramid_6 import LSTMGenerator, LSTMDiscriminator
...
for i in range(1,6):
    ...
    end_name = 'data/split/hanagwahak_train.csv'  # ISSDA의 80%인 training data
    ...
    # location of datasets and category
    # end_name = 'cpu_utilization_asg_misconfiguration.csv' # dataset name
    end_name = 'data/split/hanagwahak_test.csv'  # ISSDA의 80%인 training data
    data_file = './' + end_name  # dataset category and dataset name
    key = 'realKnownCause/' + end_name  # This key is used for reading anomaly labels
